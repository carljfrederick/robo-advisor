...
def recommend_portfolio(intent_request):
    ...
    # Validates that the value of age should be greater than zero and less than 65
    if age is not None:
        age = parse_int(
            age)
        if age > 65:
            return build_validation_result(
                False,
                "age",
                "This service is for investors that are 65 years or younger."
            )
    
    # Validates value of investment_amount should be greater than or equal to 5000
    if investment_amount is not None:
        ...
        if investment_amount < 5000:
            return build_validation_result(
                False,
                "investment_amount",
                "The investment amount must be $5000 or more."
